...
public class TestAnimationCloningActivity extends Activity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test_animation_demo_2);
        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.test_animation_cloning_container);
        final MyAnimationView myAnimationView = new MyAnimationView(this);
        linearLayout.addView(myAnimationView);
        Button btn = (Button) findViewById(R.id.test_animation_cloning_btn);
