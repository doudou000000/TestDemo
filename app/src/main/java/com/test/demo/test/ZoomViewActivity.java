...
public class ZoomViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        thumbButton = (ImageButton) findViewById(R.id.zoom_view_thumb_button_1);
        thumbButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                zoomImageFromThumb(thumbButton, R.drawable.thumb_larger);
            }
        });
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        findViewById(R.id.zoom_view_container)
