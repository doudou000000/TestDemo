...
public class TaskActivityD extends BaseActivity {
    ...
    public void initView() {
        ...
        textView.setText("TaskActivityD==TaskId===" + getTaskId());
    }
    ...
    public void initListener() {
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IntentUtils.startActivity(TaskActivityD.this,TaskActivityA.class);
            }
        });
    }
}
